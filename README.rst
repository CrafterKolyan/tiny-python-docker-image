...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.11 MB,3.9.6
    ...
    Dockerfile.python-slim,Minimal packages needed to run python,122.1 MB,3.9.6
    Dockerfile.python,Python Debian-based Official with a lot of packages,911.2 MB,3.9.6
