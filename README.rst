...
.. csv-table::
    ...
    Dockerfile.python-slim,Minimal packages needed to run python,125 MB,3.10.5
    Dockerfile.python,Python Debian-based Official with a lot of packages,919.6 MB,3.10.5
