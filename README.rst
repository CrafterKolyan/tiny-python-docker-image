...
.. csv-table::
    ...
    Dockerfile.python-alpine,Python Alpine-based Official,45.2 MB,3.9.6
    Dockerfile.alpine,Alpine-based,51.75 MB,3.9.5
    Dockerfile.ubuntu,Ubuntu-based,105.5 MB,3.8.10
    Dockerfile.python-slim,Minimal packages needed to run python,114.9 MB,3.9.6
    Dockerfile.python,Python Debian-based Official with a lot of packages,886 MB,3.9.6
