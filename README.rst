...
.. csv-table::
    ...
    Dockerfile.python-slim,Minimal packages needed to run python,120.3 MB,3.13.6
    Dockerfile.python,Python Debian-based Official with a lot of packages,1018 MB,3.13.6
