...
.. csv-table::
    ...
    Dockerfile.scratch-minimal,Minimal Python image with almost no libraries from scratch,7.27 MB,3.12.3
    Dockerfile.scratch-full,Smallest Python image with default libraries from scratch,23.19 MB,3.12.3
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),35.35 MB,3.12.5
    Dockerfile.alpine,Alpine-based,48.42 MB,3.12.3
    Dockerfile.python-alpine,Python Alpine-based Official,52.51 MB,3.12.5
    Dockerfile.ubuntu,Ubuntu-based,116.6 MB,3.12.3
    Dockerfile.python-slim,Minimal packages needed to run python,124.3 MB,3.12.5
    Dockerfile.python,Python Debian-based Official with a lot of packages,1013 MB,3.12.5
