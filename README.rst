...
.. csv-table::
    ...
    Dockerfile.scratch-minimal,Minimal Python image with almost no libraries from scratch,7.28 MB,3.12.6
    Dockerfile.scratch-full,Smallest Python image with default libraries from scratch,22.92 MB,3.12.6
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),35.37 MB,3.12.6
    Dockerfile.python-alpine,Python Alpine-based Official,46.8 MB,3.12.6
    Dockerfile.alpine,Alpine-based,48.18 MB,3.12.6
    Dockerfile.ubuntu,Ubuntu-based,116.6 MB,3.12.3
    Dockerfile.python-slim,Minimal packages needed to run python,124.3 MB,3.12.6
    Dockerfile.python,Python Debian-based Official with a lot of packages,1013 MB,3.12.6
