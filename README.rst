...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),38.15 MB,3.11.0
    Dockerfile.python-alpine,Python Alpine-based Official,52.37 MB,3.11.0
