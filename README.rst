...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.1 MB,3.9.5
    Dockerfile.python-alpine,Python Alpine-based Official,45.02 MB,3.9.5
    Dockerfile.alpine,Alpine-based,49.25 MB,3.8.10
    Dockerfile.ubuntu,Ubuntu-based,105.4 MB,3.8.5
    Dockerfile.python-slim,Minimal packages needed to run python,114.8 MB,3.9.5
    Dockerfile.python,Python Debian-based Official with a lot of packages,885.8 MB,3.9.5
