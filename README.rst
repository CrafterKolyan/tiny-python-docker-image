...
.. csv-table::
    ...
    Dockerfile.python-alpine,Python Alpine-based Official,48.66 MB,3.10.7
    ...
    Dockerfile.python,Python Debian-based Official with a lot of packages,921.1 MB,3.10.7
