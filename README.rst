...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.54 MB,3.10.4
    Dockerfile.python-alpine,Python Alpine-based Official,47.8 MB,3.10.4
