...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.58 MB,3.10.2
    Dockerfile.python-alpine,Python Alpine-based Official,48.66 MB,3.10.2
    ...
    Dockerfile.python,Python Debian-based Official with a lot of packages,916.8 MB,3.10.2
