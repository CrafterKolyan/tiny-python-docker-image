...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),37.6 MB,3.14.3
    Dockerfile.python-alpine,Python Alpine-based Official,47.41 MB,3.14.3
    Dockerfile.alpine,Alpine-based,49.4 MB,3.12.12
    Dockerfile.ubuntu,Ubuntu-based,116.7 MB,3.12.3
    Dockerfile.python-slim,Minimal packages needed to run python,119 MB,3.14.3
    Dockerfile.python,Python Debian-based Official with a lot of packages,1116 MB,3.14.3
