...
.. csv-table::
    ...
    Dockerfile.python-alpine,Python Alpine-based Official,48.65 MB,3.10.2
    ...
    Dockerfile.python,Python Debian-based Official with a lot of packages,885.5 MB,3.10.2
