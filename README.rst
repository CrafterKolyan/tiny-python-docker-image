...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),33.65 MB,3.10.6
    Dockerfile.python-alpine,Python Alpine-based Official,48.66 MB,3.10.6
