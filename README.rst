...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.53 MB,3.10.1
    Dockerfile.python-alpine,Python Alpine-based Official,45.39 MB,3.10.1
    Dockerfile.alpine,Alpine-based,51.72 MB,3.9.7
    Dockerfile.ubuntu,Ubuntu-based,105.5 MB,3.8.10
    Dockerfile.python-slim,Minimal packages needed to run python,122.5 MB,3.10.1
    Dockerfile.python,Python Debian-based Official with a lot of packages,916.6 MB,3.10.1
