...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),32.53 MB,3.10.0
    Dockerfile.python-alpine,Python Alpine-based Official,45.38 MB,3.10.0
