...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),38.15 MB,3.11.1
    Dockerfile.python-alpine,Python Alpine-based Official,52.38 MB,3.11.1
    ...
    Dockerfile.python,Python Debian-based Official with a lot of packages,931.8 MB,3.11.1
