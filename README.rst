...
.. csv-table::
    ...
    Dockerfile.scratch-minimal,Minimal Python image with almost no libraries from scratch,7.3 MB,3.12.10
    Dockerfile.scratch-full,Smallest Python image with default libraries from scratch,23.02 MB,3.12.10
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),35.38 MB,3.13.3
    Dockerfile.python-alpine,Python Alpine-based Official,44.82 MB,3.13.3
    Dockerfile.alpine,Alpine-based,48.28 MB,3.12.10
