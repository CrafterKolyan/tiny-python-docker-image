...
.. csv-table::
    ...
    Dockerfile.scratch-minimal,Minimal Python image with almost no libraries from scratch,7.566 MB,3.12.12
    Dockerfile.scratch-full,Smallest Python image with default libraries from scratch,23.43 MB,3.12.12
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),37.56 MB,3.14.2
    Dockerfile.python-alpine,Python Alpine-based Official,47.38 MB,3.14.2
    Dockerfile.alpine,Alpine-based,49.4 MB,3.12.12
    Dockerfile.ubuntu,Ubuntu-based,116.7 MB,3.12.3
    Dockerfile.python-slim,Minimal packages needed to run python,118.9 MB,3.14.2
    Dockerfile.python,Python Debian-based Official with a lot of packages,1116 MB,3.14.2
