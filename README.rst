...
.. csv-table::
    ...
    Dockerfile.haizaar-minimal,Stripped official Python image (`haizaar/python-minimal`_),37.36 MB,3.14.1
    Dockerfile.python-alpine,Python Alpine-based Official,47.17 MB,3.14.1
